...
# on. Docker will run mapping this directory to /homedir/wine/drive_c/electronnovo
# which inside wine will look like c:\electronnovo.
...
(
    ...
    -v "$FRESH_CLONE_DIR":/homedir/wine/drive_c/electronnovo:delegated \
    --rm \
    --workdir /homedir/wine/drive_c/electronnovo/contrib/build-wine \
    $IMGNAME \
    ./_build.sh $REV
